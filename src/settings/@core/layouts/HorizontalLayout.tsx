...
// ** Type Import
import { LayoutProps } from 'src/settings/@core/layouts/types'

// ** Components
import Customizer from 'src/settings/@core/components/customizer'
import Footer from './components/shared-components/footer'
import Navigation from './components/horizontal/navigation'
import ScrollToTop from 'src/settings/@core/components/scroll-to-top'
...
// ** Styled Component
import DatePickerWrapper from 'src/settings/@core/styles/libs/react-datepicker'
