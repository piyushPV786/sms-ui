...
// ** Types
import { NavGroup } from 'src/settings/@core/layouts/types'
import { Settings } from 'src/settings/@core/context/settingsContext'

// ** Custom Components Imports
import HorizontalNavItems from './HorizontalNavItems'
import UserIcon from 'src/settings/layouts/components/UserIcon'
import Translations from 'src/settings/layouts/components/Translations'
import CanViewNavGroup from 'src/settings/layouts/components/acl/CanViewNavGroup'

// ** Utils
import { hexToRGBA } from 'src/settings/@core/utils/hex-to-rgba'
import { hasActiveChild } from 'src/settings/@core/layouts/utils'
