...
// ** Types
import { NavSectionTitle } from 'src/settings/@core/layouts/types'
...
import CanViewNavSectionTitle from 'src/settings/layouts/components/acl/CanViewNavSectionTitle'
