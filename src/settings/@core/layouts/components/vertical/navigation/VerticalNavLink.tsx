...
// ** Types
import { NavLink, NavGroup } from 'src/settings/@core/layouts/types'
...
import CanViewNavLink from 'src/settings/layouts/components/acl/CanViewNavLink'

// ** Utils
import { handleURLQueries } from 'src/settings/@core/layouts/utils'
