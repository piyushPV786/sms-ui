...
} from 'src/settings/@core/layouts/types'
...
const themeConfig: ThemeConfig = {
  // ** Layout Configs
  templateName: 'Reggie SMS' /* App Name */,
  layout: 'vertical' /* vertical | horizontal */,
  mode: 'light' /* light | dark */,
  direction: 'ltr' /* ltr | rtl */,
  skin: 'semi-dark' /* default | bordered |  /*! Note: semi-dark value will only work for Vertical Layout */,
